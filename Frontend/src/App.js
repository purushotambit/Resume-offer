...
import ResumeOption from './components/UI/Our Features/ResumeOption';
...
function App() {
  ...
  return (
    <BrowserRouter>
    {/* http://localhost:5000 */}
    {/* https://resumeletter.onrender.com */}
      ...
      <Routes>
        ...
        <Route
          exact
          path='/resume/option'
          element={user?<ResumeOption/> :<Navigate to="/login"/>}
        />
        <Route
      exact path='/resume1' element={user ? <Resume1 /> : <Navigate to="/login" />}/>
      <Route
      exact path='/resume2' element={user ? <Resume2 /> : <Navigate to="/login" />}/>
        <Route
          exact
